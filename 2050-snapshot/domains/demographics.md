...
Africa still growing — Asia declining. Sub-Saharan Africa continues growing (though slowing rapidly, with TFR approaching replacement at ~2.8), while East Asia, Europe, and Latin America are in sustained decline. Global population stands at approximately 9.5 billion and declining, having peaked at ~9.7B in 2043. This demographic asymmetry drives structural migration pressure from the still-growing Global South toward the shrinking North — a pressure that no border enforcement regime can fully contain.

### Global Thematic Sections

#### Fertility Decline & Below-Replacement Transition

- **Global average TFR:** ~2.0, below replacement for the first time in modern history. The global fertility rate crossed below the 2.1 replacement threshold in the early 2040s (T-13) and continues its slow decline.
- **Regional TFR snapshot:**
  - Sub-Saharan Africa: ~2.8 (declining — urbanization, education, and economic development continue the fertility transition)
  - Middle East/North Africa: ~2.2 (approaching replacement)
  - South Asia: ~1.8 (below replacement — India crossed below 2.1 in the early 2020s)
  - Latin America: ~1.6 (below replacement)
  - East Asia: ~1.1 (among the lowest in human history — China ~1.1, ROK ~0.7, DPRK ~1.8)
  - Europe: ~1.4 (Nordic core somewhat higher at ~1.6; periphery lower)
  - North America (successor states): ~1.5-1.8 (varying by entity — see entity profiles)
- **Implications:** Long-term population decline is now structurally set in globally, with regional variation determining which entities shrink, which stabilize, and which continue modest growth. No region outside Sub-Saharan Africa maintains replacement fertility. The global population decline that began in the 2040s will continue through the second half of the century, with projections suggesting a return to ~8-9 billion by 2100 depending on fertility trajectory and longevity trends.
...
- **Aged societies (median >40):** Japan (~52), ROK (~54), European Federation (~46), China (~42), Mountain Tapestry (~41), Atlantica (~40), HFS (~40), Alaska (~40), Florida (~44), Kentucky (~42), Virginia (~43), Great Lakes (~39)
...
- **Dependency ratio pressures:** The working-age population (25-64) is shrinking relative to the 65+ population in all developed and most middle-income regions. Old-age dependency ratios (65+/25-64) exceed 40% in ROK, Japan, European Federation, and China. The ratio exceeds 30% in all revolutionary successor states.
- **Automation offset:** Automation partially offsets labor force decline in automated economies — humanoid robots and AI-driven systems substitute for a significant share of working-age tasks in the Pacifica, Atlantica, Great Lakes, European Federation, China, and ROK. Labor-intensive economies (EAF, India's informal sector, reactionary states) face growth constraints from both aging and emigration without automation substitution.
...
#### Climate Migration (Standalone Section)

Climate-driven migration is one of the defining demographic forces shaping the 2050 world — closely linked to both the climate snapshot and the borders/geopolitics analysis.

- **Scale:** 50-80 million cumulative climate migrants globally (consistent with prediction-003's HIGH-confidence forecast of 50M+). This includes both cross-border migration (~40%) and internal displacement (~60%). The cumulative figure represents approximately 0.8% of global population — a significant demographic force concentrated in specific source and destination regions.
- **Source regions:**
  - Bangladesh delta: ~15M — the single largest source region. Chronic tidal flooding, saltwater intrusion into agricultural land, and cyclone intensification have made large areas of coastal Bangladesh functionally uninhabitable. Migration to Dhaka, India, and Southeast Asia.
  - Sahel belt (Mali, Burkina Faso, Niger, Chad, Sudan): ~10M — desertification and agricultural collapse drive displacement toward coastal West Africa, the East African highlands, and North Africa.
  - Mekong Delta (Vietnam): ~8M — sea level rise and saltwater intrusion have reduced rice production by ~40% and displaced farming communities to Ho Chi Minh City and inland provinces.
  - South Asia monsoon belt (India, Pakistan, Nepal): ~10M — increased flood frequency and severity from monsoon destabilization, compounded by Himalayan glacier retreat reducing dry-season water availability.
  - Pacific Islands: ~3M (majority of several atoll-state populations — Tuvalu, Kiribati, Marshall Islands — are effectively diaspora nations with residual sovereign territory)
...
- **Destination regions:**
  ...
  - Europe: The European Federation maintains controlled migration; the reactionary periphery (France, Italy) has sealed borders, creating a humanitarian crisis at Mediterranean entry points.
...
- **TFR:** 1.6
- **Net migration:** +0.8%/yr (highest among successor states — attracts migrants from Central America, Asia, and reactionary states)
- **Urbanization:** 88% (coastal urban corridor — San Diego to Seattle — is among the most urbanized regions globally)
- **Life expectancy:** 82 (highest in former US — universal healthcare system, clean energy environment, strong public health infrastructure)
- **Ethnic/religious composition:** 40% white, 30% Hispanic/Latino, 12% Asian, 8% Black, 10% other/multiracial. Religious landscape: secular majority, significant Catholic and Protestant minorities, growing Buddhist and Muslim communities from immigration.
- **Labor force participation:** 62% (UBI floor reduces labor force pressure — participation reflects voluntary engagement rather than economic necessity)
...
- **Population:** 8M
- **Age structure:** Median age 36, dependency ratio 50%
- **TFR:** 1.8
- **Net migration:** +0.6%/yr (attracts climate migrants from the drying Southwest and political migrants from surrounding reactionary states)
- **Urbanization:** 75% (Front Range urban corridor — Denver/Boulder/Fort Collins/Colorado Springs — contains vast majority of population)
- **Life expectancy:** 80 (strong healthcare access concentrated in urban corridor; rural and mountain areas less served)
- **Ethnic/religious composition:** 50% white, 30% Hispanic, 10% Indigenous, 10% other. Religious landscape: secular majority with significant Catholic and Protestant minorities.
- **Labor force participation:** 65% (high — technology, aerospace, and renewable energy sectors drive employment)
- **Primary languages:** English, Spanish, Navajo
...
- **TFR:** 1.9
- **Net migration:** +0.7%/yr (attracts Hispanic/Latinx migrants from throughout the Americas, plus climate migrants from Central America's Dry Corridor)
- **Urbanization:** 85% (Phoenix, Tucson, Albuquerque, El Paso metro areas — water-constrained but dense)
- **Life expectancy:** 81 (universal basic services model provides healthcare access; clean energy environment beneficial)
- **Ethnic/religious composition:** 70% Hispanic/Latino, 15% white, 10% Indigenous, 5% other. Religious landscape: Catholic majority, significant secular minority, Indigenous spiritual traditions.
- **Labor force participation:** 66% (high — semiconductor, solar energy, and construction sectors drive strong labor demand)
- **Primary languages:** Spanish, English, Indigenous languages (Navajo, Hopi, Pueblo languages)
- **→ See KML: Aztlán**

**Hawaiian Free State (HFS):**
- **Population:** 1.8M
- **Age structure:** Median age 40, dependency ratio 55%
- **TFR:** 1.7
- **Net migration:** +0.2%/yr (modest — limited by island geography and controlled migration policy)
- **Urbanization:** 80% (Honolulu urban corridor; outer islands more rural)
- **Life expectancy:** 83 (highest in former US — clean environment, strong community health systems, Pacific Islander longevity traditions)
- **Ethnic/religious composition:** 35% Native Hawaiian/Pacific Islander, 30% Asian, 20% white, 15% other. Religious landscape: Christian majority (Catholic, Protestant, Mormon), significant Buddhist minority, Native Hawaiian spiritual revival.
...
- **Population:** 450K
- **Age structure:** Median age 30, dependency ratio 52%
- **TFR:** 2.5 (above replacement — highest among successor state entities)
- **Net migration:** +0.5%/yr (return migration from diaspora — Landback and sovereignty enable repatriation)
- **Urbanization:** 45% (largely rural — dispersed settlement across 27,425 sq miles; Window Rock and Chinle as administrative centers)
- **Life expectancy:** 76 (improved from early-2020s baseline of ~73 — healthcare investments and environmental cleanup from coal transition)
- **Ethnic/religious composition:** 90% Navajo (Diné), 10% other Indigenous/Hispanic. Religious landscape: Navajo traditional spirituality (Hózhó philosophy), Christian minority (Navajo Reformed Church, Catholic).
- **Labor force participation:** 55% (solar energy, tourism, crafts, and cooperative enterprises; transitioning from fossil fuel employment base)
- **Primary languages:** Navajo (Diné bizaad), English, Spanish
...
- **Net migration:** +0.6%/yr (return migration — diaspora repatriation driven by Landback and cultural revitalization)
- **Urbanization:** 40% (lowest among successor state entities — dispersed across treaty territories in ND, SD, NE)
- **Life expectancy:** 75 (improved — healthcare sovereignty and traditional food systems restoration)
- **Ethnic/religious composition:** 85% Lakota/Dakota, 15% other. Religious landscape: Lakota spirituality (Wicóȟaŋpi), Christian minority (Episcopalian, Catholic), syncretic traditions.
- **Labor force participation:** 50% (bison-based agriculture, renewable energy cooperatives, tourism, traditional crafts)
- **Primary languages:** Lakota, Dakota, English
- **→ See KML: Dakota/Lakota Nation**

**Sequoyan Nation (Cherokee):**
- **Population:** 350K
- **Age structure:** Median age 33, dependency ratio 50%
- **TFR:** 2.3 (above replacement)
- **Net migration:** +0.4%/yr (moderate return migration from diaspora; some in-migration from surrounding reactionary territories)
- **Urbanization:** 55% (Tahlequah as capital; dispersed communities across 7,000 sq mi in northeastern Oklahoma)
- **Life expectancy:** 77 (strong healthcare system — Cherokee Nation Health Services is the most comprehensive indigenous healthcare system in the former US)
- **Ethnic/religious composition:** 80% Cherokee, 20% other. Religious landscape: Christian majority (Baptist, Methodist), Cherokee spiritual traditions revival, Keetoowah Society.
- **Labor force participation:** 55% (healthcare, education, manufacturing, gaming, technology services)
...
- **TFR:** 2.4 (above replacement)
- **Net migration:** +0.2%/yr (modest return migration; limited by remote geography)
- **Urbanization:** 50% (Juneau, Sitka, Ketchikan as primary population centers; dispersed coastal communities)
- **Life expectancy:** 74 (improved from early-2020s baseline — healthcare investments and traditional food system restoration)
...
- **Population:** 150K
- **Age structure:** Median age 35, dependency ratio 50%
...
- **Age structure:** Median age 39, dependency ratio 56%
- **TFR:** 1.7
- **Net migration:** -0.3%/yr (out-migration — economic decline and limited opportunity drive population loss)
- **Urbanization:** 60% (Omaha, Lincoln, Wichita, Kansas City metro areas)
- **Life expectancy:** 78 (comparatively higher than other reactionary states — less industrial pollution, lower population density)
...
- **Population:** 6M
- **Age structure:** Median age 35, dependency ratio 50%
- **TFR:** 2.2 (highest among reactionary states — LDS cultural emphasis on family maintains above-replacement fertility despite economic decline)
- **Net migration:** +0.1%/yr (near-zero — some in-migration from diaspora LDS members returning to the Corridor as conditions worsen elsewhere, offset by youth out-migration to revolutionary states)
- **Urbanization:** 75% (Wasatch Front — Salt Lake City, Provo, Ogden — contains ~80% of population)
- **Life expectancy:** 80 (LDS health practices — no alcohol/tobacco, strong community networks — produce above-average longevity despite degraded healthcare infrastructure)
- **Ethnic/religious composition:** 75% white, 12% Hispanic, 8% Pacific Islander (historical LDS missionary connections), 5% other. Religious landscape: LDS (Mormon) ~55%, other Christian ~15%, secular/unaffiliated ~30%.
- **Labor force participation:** 64% (LDS church provides economic coordination and conditional social welfare; residual tech sector, mining, agriculture)
- **Primary languages:** English, Spanish
- **→ See KML: Deseret**

**Mountain Tapestry:**
- **Population:** 3M (widely dispersed, declining — mostly absorbed or dissolved entities)
- **Age structure:** Median age 41, dependency ratio 58%
- **TFR:** 1.7
- **Net migration:** -0.4%/yr (out-migration — economic collapse and lack of opportunity drive population loss)
- **Urbanization:** 55% (small cities — Billings, Bozeman, Missoula, Idaho Falls — as population centers; vast rural areas)
- **Life expectancy:** 76 (degraded healthcare infrastructure; extraction economy health impacts)
- **Ethnic/religious composition:** 70% white, 15% Hispanic, 10% Indigenous, 5% other. Religious landscape: Evangelical Protestant, LDS minority in southern Idaho.
- **Labor force participation:** 54% (extraction, ranching, tourism — seasonal and declining; no social safety net)
- **Primary languages:** English, Spanish
...
- **TFR:** 1.7
- **Net migration:** -1.0%/yr (highest net out-migration rate among successor states — population exodus to indigenous territories and what remains of the Lower 48)
- **Urbanization:** 70% (Anchorage/Mat-Su urban corridor; Fairbanks and Kenai Peninsula secondary)
- **Life expectancy:** 75 (degraded healthcare — oil revenue collapse ended public health funding; extreme cold and food insecurity compound)
...
- **Life expectancy:** 87 (highest globally, shared with the Pacifica and European Federation — universal healthcare, healthy diet, and active elderly lifestyle; the centenarian population exceeds 500K)
...
- **Net migration:** +0.1%/yr (modest in-migration from neighboring South American states; some climate migration from Amazon dieback zone)
- **Urbanization:** 90% (São Paulo, Rio de Janeiro, Brasília, Belo Horizonte, Porto Alegre as primary urban centers)
- **Life expectancy:** 78 (declining slightly from pre-dieback projections — Amazon dieback air quality and heat effects in northern and central regions)
- **Labor force participation:** 58% (Amazon dieback reduced agricultural employment; services and technology sectors growing; informal sector significant)
- **Primary languages:** Portuguese, Indigenous languages
- **→ See KML: Brazil**
- → See transition doc: [demographics.md Driver 2](../../2026-2050-transition/demographics.md#driver-2-climate-driven-migration-acceleration), event T-15

**East African Federation (EAF):**
- **Population:** 280M (growing — highest growth rate among key global powers)
- **Age structure:** Median age 22, dependency ratio 45%
- **TFR:** 3.2 (above replacement — declining but still the highest among all profiled entities)
- **Net migration:** +0.5%/yr (attracts migrants from Sahel, Horn of Africa, and Central Africa — EAF free movement zone)
- **Urbanization:** 35% (Nairobi, Kampala, Dar es Salaam, Kigali, Juba as growing urban centers; majority still rural)
- **Life expectancy:** 68 (improving — healthcare investments and malaria reduction; climate-related disease burden still significant)
- **Labor force participation:** 52% (agriculture dominant; services and logistics growing; limited automation outside capital-intensive sectors)
- **Primary languages:** Swahili, English, regional languages (Kikuyu, Luganda, Kinyarwanda, Dholuo, Amharic, Oromo)
...
- **Urbanization:** 75% (Moscow, St. Petersburg, Novosibirsk, Yekaterinburg as primary urban centers; Siberian and Far Eastern cities declining)
- **Life expectancy:** 73 (stagnant — alcohol-related mortality legacy, healthcare system strain from war economy, environmental degradation in industrial zones)
...
- **Age structure:** Median age 34, dependency ratio 48%
- **TFR:** 1.8 (below replacement)
- **Net migration:** +0.2%/yr (attracts migrants from Syria, Iraq, Afghanistan, and Sub-Saharan Africa — managed migration under Quartet framework)
- **Urbanization:** 78% (Istanbul, Ankara, Izmir, Bursa as primary urban centers)
- **Life expectancy:** 78 (moderate — healthcare system strained by refugee population; pollution in industrial urban centers)
- **Labor force participation:** 54% (manufacturing moderately automated; construction labor-intensive; services growing)
- **Primary languages:** Turkish, Kurdish, Arabic
- **→ See KML: Turkey**
...
**Antarctica:** {#antarctica} Non-sovereign population — no indigenous inhabitants, no permanent citizenry, all residents are rotational or permanent station staff under claimant-state administration under the Santiago Protocol (2042).

- **Permanent population:** ~5,000-8,000 year-round residents across all Antarctic stations, up from ~1,100 in the 2020s. Growth driven by: (1) expanded Chinese station infrastructure (Marie Byrd Land, East Antarctic plateau), (2) extraction workforce (subsurface mining operations under the ice-structure mandate), (3) new claimant infrastructure (Brazilian Antarctic Territory, Indian Antarctic Territory), and (4) multi-year research programs requiring continuous staffing. The permanent population is concentrated in four clusters: the Antarctic Peninsula (ACJAT "San Martín" — Chile with Argentine condominium, ~2,500 year-round — the most populous Antarctic region due to milder climate and extraction activity), the Ross Sea/McMurdo area (NZ Ross Dependency, ~1,500 — Christchurch logistics hub proximity), the Chinese East Antarctic stations (Marie Byrd Land + inland plateau, ~2,000 — China's infrastructure buildout), and the Atlantic sector (Brazilian Antarctic Territory + Norwegian Dronning Maud Land, ~800 — the newest population cluster driven by Brazil's station construction and BAS legacy operations). The remaining ~1,200-2,200 are distributed across Australian, French, Indian, Russian, and South African stations. British Antarctic Survey (BAS) scientists continue to operate Rothera and Halley stations in the Brazilian Antarctic Territory (former British Antarctic Territory, 20°W–53°W) — the UK's Antarctic claim is defunct (dissolved with UK sovereignty), and BAS personnel are non-claimant scientific staff operating under bilateral agreement with Brazil and Chile.

- **Rotational/seasonal population:** 30,000-40,000 summer personnel (October-March) — researchers, logistics workers, extraction crews, construction teams, and tourism support staff. The summer population peaks in December-January during the research and construction season. Summer personnel are predominantly: Chinese nationals (~35%, reflecting China's infrastructure scale), Argentine and Chilean nationals (~18%, Peninsula zone proximity), Brazilian nationals (~8%, growing rapidly with Brazilian Antarctic Territory development), and a mix of EU, Indian, Commonwealth, and BRICS+ nationals (~39%). The seasonal workforce rotates on 3-6 month contracts — most personnel winter elsewhere (gateway-port cities, home countries).

- **Claimant-nationality demographics:** Station populations reflect claimant-state demographics under the Santiago Protocol. The largest single nationality bloc is Chinese (~35-40% of permanent population, concentrated in Marie Byrd Land and inland plateau stations). Argentine and Chilean nationals are the second-largest group (~15-18%, concentrated in the ACJAT Peninsula zone with family housing — the only Antarctic stations with multi-generation families). Brazilian nationals are the fastest-growing cohort (~5-8%, concentrated in the Brazilian Antarctic Territory and Brazilian Navy-operated stations). Australian, NZ, French, and Norwegian nationals collectively account for ~18% (their respective claim zones). Indian nationals account for ~5-7% (concentrated in the Indian Antarctic Territory at Bharati station). The remaining ~15-20% are South African, Russian, Japanese, PPR, and other non-claimant nationals. China's demographic dominance is a direct consequence of infrastructure scale — more stations = more personnel = larger permanent population footprint.

- **Station communities:** Antarctic stations function as small towns — self-contained communities with housing, dining, medical facilities, recreation, and communications. The largest stations (McMurdo-area cluster, Chinese Zhongshan/Kunlun, Argentine Esperanza, Brazilian Comandante Ferraz) have populations of 200-500 year-round and 1,000+ in summer — comparable to small remote settlements. Station life creates a distinctive social structure: hierarchical (station chief/commander, science leads, support staff), cooperative (survival interdependence), and transient (most personnel rotate within 1-3 years). Long-term station staff (5+ year tenures) are a small but influential cohort that provides institutional continuity. New Brazilian and Indian stations are building permanent community infrastructure — Brazil's Antarctic Program emphasizes naval-family culture (COMANDANTE FERRAZ station has family housing under construction).

- **Emergent Antarctic identity:** Multi-generation station families — children born at Antarctic stations (primarily Argentine Esperanza and Chilean Frei bases, which have maternity facilities as sovereignty demonstrations) — represent the first generation of "Antarctican-born" individuals. Estimated 20-40 Antarctic-born children by 2050, all holding claimant-state citizenship. An emergent "Antarctican" identity is cultural rather than political — shared experience of station life, extreme environment adaptation, and scientific internationalism — but it does not constitute a sovereignty claim or independence movement. Station "lifers" (career Antarctic personnel with 20+ year tenures) are the primary carriers of this identity. The Brazilian Antarctic Territory's development and India's purchase of the eastern AAT are introducing new national cultures to the Antarctic station community — Portuguese-speaking and Hindi/Marathi-speaking station populations are the newest linguistic cohorts.
...
- **Demographic pressures:** The primary demographic pressure is growth management — how many people can Antarctica support without degrading the environment? Station waste management, fuel consumption, and invasive species introduction scale with population. The ice-structure mandate limits surface infrastructure, indirectly capping population growth. The second pressure is workforce composition — as subsurface extraction expands, the ratio of extraction workers to research scientists shifts, changing station culture from scientific-internationalist to resource-industrial. This cultural shift is most visible in the Chinese MBL and Brazilian Antarctic Territory stations.
...
- **Global fertility decline and below-replacement transition** — Structural decline in TFR across all major regions, driven by urbanization, women's education, economic precarity, and climate anxiety. The total fertility rate crossed below global replacement level (~2.1) in the early 2040s (T-13). **→ See transition doc: [demographics.md Driver 1](../../2026-2050-transition/demographics.md#driver-1-global-fertility-decline-and-population-aging)**
- **Climate-driven migration acceleration** — The scale of cross-border climate migration exceeded 20 million by 2036 (T-09) and 50 million by 2050, making climate migrants a permanent feature of global demographics. The Amazon dieback (T-15) added a new migration wave in the late 2040s. **→ See transition doc: [demographics.md Driver 2](../../2026-2050-transition/demographics.md#driver-2-climate-driven-migration-acceleration), events T-09, T-15**
- **Post-US federal fragmentation and successor state demographic divergence** — The collapse of the United States produced 19 successor entities with divergent migration regimes and population policies. Revolutionary states (socialist economic models with universal welfare) attract population; reactionary states (nationalist-capitalist, no safety nets) lose population. **→ See transition doc: [demographics.md Driver 3](../../2026-2050-transition/demographics.md#driver-3-us-successor-state-demographic-divergence), → See transition doc: [successor-states.md](../../2026-2050-transition/successor-states.md)**
- **Urbanization and coastal retreat patterns** — Global urbanization reached ~70% by 2050, driven by both economic pull (city employment) and climate push (coastal retreat). Inland "climate haven" cities absorb coastal displaced populations. **→ See transition doc: [demographics.md Driver 4](../../2026-2050-transition/demographics.md#driver-4-urbanization-and-coastal-abandonment), → See climate snapshot: [Sea Level Rise](../../2050-snapshot/domains/climate.md#sea-level-rise)**
...
- **To Economy:** Labor force size and age structure determine economic growth potential. Automation partially offsets demographic decline in revolutionary states and advanced economies — humanoid robots and AI substitute for shrinking working-age populations. UBI and guaranteed employment programs (Pacifica, Atlantica, Great Lakes, Aztlán, European Federation) are direct policy responses to demographic + automation pressure. Reactionary states face a demographic-economic doom loop — population decline reduces economic activity, which accelerates out-migration, which further reduces population. **→ See also: [economy.md](../../2050-snapshot/domains/economy.md)**
- **To Climate:** Climate migration is the primary demographic disruptor of the mid-century — 50-80 million cumulative climate migrants globally. Source regions (Sahel, Bangladesh delta, Mekong Delta, Pacific Islands, Amazon basin) experience population loss and structural aging as working-age adults leave. Destination regions (Pacifica, European Federation, East Africa, Australia/NZ) gain population but face integration challenges and infrastructure strain. Mortality from extreme events (heatwaves, floods, fires) becomes a measurable demographic factor — heatwave-related deaths are estimated at 500K+ annually in South Asia, the Middle East, and West Africa. Fertility decisions influenced by climate anxiety and economic precarity in affected regions. **→ See also: [climate.md](../../2050-snapshot/domains/climate.md)**
...
- **To Culture:** Age structure shapes cultural values and political ideology — aging societies (European Federation, ROK, DPRK, China) tilt toward conservatism and stability; young societies (EAF, indigenous nations) are more dynamic and open to transformation. Migration creates cultural change in destination regions — revolutionary states' cosmopolitan multiculturalism vs reactionary states' defensive nationalism. Demographic decline in reactionary states and Japan produces a cultural psychology of loss and nostalgia. **→ See also: culture.md**

## Key Uncertainties

- **Fertility trajectory in Sub-Saharan Africa:** The key variable in global population projections. If TFR falls faster than current estimates (toward replacement by 2060 rather than 2080-2100), global population decline accelerates. If fertility stabilizes at 2.5-3.0 for longer, Sub-Saharan Africa's demographic weight increases dramatically. The EAF's TFR of 3.2 is the highest among profiled entities and the most uncertain projection.
- **Climate migration scale:** Could exceed 80 million if tipping events cascade — an AMOC collapse, accelerated West Antarctic ice sheet loss, or additional Amazon/savanna dieback zones would add migration pressure beyond current estimates. The 50-80 million range used here reflects the conservative-to-midrange estimate.
- **Automation-labor substitution rate:** Determines whether demographic decline becomes economic crisis or manageable transition. If automation substitutes effectively for 40-60%+ of working-age tasks (as projected in revolutionary states), population decline is economically manageable. If automation plateaus or is blocked by regulatory/social resistance, the dependency ratio crisis deepens.
- **Return migration potential:** If conditions improve in source regions through climate adaptation, economic development, or political stabilization, could some climate and economic migrants return? The Sahel's trajectory is the key case — if desertification can be reversed or adapted to, return migration could partially reverse current flows.
- **Pandemic or other mortality shocks:** The 2020s COVID-19 pandemic demonstrated that infectious disease can alter demographic trajectories at global scale. A more lethal pathogen in a more connected world could reshape population projections. Conversely, longevity breakthroughs (senolytic drugs, advanced gene therapy) could extend healthy lifespan significantly, altering dependency ratio calculations.
- **Successor state population policy:** Whether revolutionary states maintain open migration policies as their own populations age and infrastructure strains, or whether they tighten borders as demographic pressures shift. The Pacifica's managed immigration model is the key experiment — if it succeeds, other revolutionary states emulate it; if it creates integration crises, migration policy tightens across the revolutionary bloc.

---

*Demographics domain section of the 2050 steady-state snapshot. References prediction-003 (climate displacement) and prediction-008 (global population peak).*
