...
- Euro: ~20% — EU Core (strong euro) and periphery (discounted euro) combined
...
- EU Core trade: Primarily euro-denominated
...
**EU Core / Periphery:** The European economic space is bifurcated into a revolutionary core and a degraded periphery.
- **Core participants:** Nordic Council states (Finland, Sweden, Denmark, Norway, Iceland), Benelux (Netherlands, Belgium, Luxembourg), post-Orbán Hungary, Slovenia, Baltic states (Estonia, Latvia, Lithuania). Operating a "Northern Euro" hard currency with strict fiscal rules, inflation targeting, and pooled debt.
- **Periphery participants:** France (post-RN recovery), Germany (post-AfD recovery with conditions), Italy, Spain, Portugal, Greece, Austria, Ireland. Using a discounted periphery euro — trading at a 10-20% discount to the Northern Euro. The single market survives but monetary union is practically split.
- **Key trade flows:** Advanced manufacturing and green tech (core), agricultural products and tourism (periphery), services and finance (core), energy (North Sea, renewable exports from Nordics)
- **Integration depth:** The core operates a joint defense federation (formalized ~2038-2039), coordinated industrial policy, common migration management, and a regulated single market. Periphery trades under looser terms — market access maintained but without core institutional benefits.
- → See borders analysis: [European Core Federation](../../2050-snapshot/domains/borders-geopolitics.md#europe)
...
**Automation penetration by sector (advanced economies — revolutionary states, EU Core, China, Japan, ROK, DPRK):**
...
- **Trade partners and bloc alignment:** BRICS+ (member — significant trade with China, Gulf states, ASEAN), EU Core, GCC (residual energy trade). The rupee is increasingly internationalized but not a reserve currency. India is a net energy importer (oil, LNG).
...
- **Trade partners and bloc alignment:** BRICS+ (primary — China is Brazil's largest trade partner by a wide margin), EU Core (agricultural and mineral exports), South America (regional trade). Brazil is a BRICS+ anchor and the regional hegemon in South America.
...
- **Trade partners and bloc alignment:** BRICS+ (primary — EAF is a BRICS+ member), China (infrastructure investment and trade), India (historical trade ties), EU Core (agricultural exports to Europe — declining as Africa-Europe trade shifts), intra-East African Community trade (growing — confederation structure)
...
- **Trade partners and bloc alignment:** China (primary — RCEP framework), Japan, ROK, DPRK, India, EU Core. ASEAN's institutional model (collective neutrality, multipolar hedging) has thrived. Singapore is a major BRICS+ financial node.
...
- **Trade partners and bloc alignment:** China (primary — energy, minerals, technology — junior partner in the relationship), BRICS+ (member), India (energy and arms), Central Asia (economic sphere of influence — through Eurasian Economic Union framework). Russia is a declining peripheral power — China-dependent.
