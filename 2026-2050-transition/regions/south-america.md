...
- **Links to US collapse:** Brazil gains geopolitical space as the US disappears from South America. It leads regional institutions without US veto power. However, it also loses US market access for exports and faces competition from US successor states (PPR, Atlantica, CSR) for BRICS+ influence.
...
- **Core territory:** The convergence of Chile (Atacama Desert — world's largest lithium producer, currently ~30% of global supply), Bolivia (Salar de Uyuni — world's largest lithium reserve, ~21 million tons, mostly undeveloped), and Argentina (Salinas Grandes — managed under the unified Argentina-Uruguay state). The Lithium Triangle remains a coordination-only framework — not a joint sovereignty zone. Argentina's lithium policy is integrated into the unified state's energy strategy.
...
- **Trajectory:** The lithium triangle becomes a strategic choke point in the global green energy transition. Revolutionary US successor states (PPR, Great Lakes, CSR) are natural buyers. The triangle governments extract better terms from a fragmented, competitive buyer market. By 2049, lithium is the new oil — and the triangle states are the new OPEC — though Chile's path is more circuitous due to its rightward detour.
...
### 4. Gran Colombia (Colombia, Ecuador, Venezuela) and Peru — Divergent Paths
- **Orientation:** Pan-nationalist unification of three states; Peru left behind (HIGH confidence for unification trajectory, MEDIUM for Peru)

**Gran Colombia Formation:**
- Colombia, Ecuador, and Venezuela all undergo left-nationalist transitions by the late 2030s (Colombia's post-Petro left consolidation, Ecuador's correísmo revival after dollarization crisis, Venezuela's post-Rodriguez left-nationalist regime).
- With all three states ideologically aligned and free from US interventionism, pan-nationalist sentiment — a deep current in Latin American political identity since Bolívar — becomes politically actionable.
- **Phase 1 (Confederal compact ~2038–2042):** A Gran Colombia Confederal Council is formed, coordinating foreign policy, trade, defense, and migration. Member states retain domestic sovereignty. Bogotá selected as capital.
- **Phase 2 (Full federation ~2045–2048):** The confederation deepens into a federation with a unified currency, federal legislature, and integrated military command. The revolutionary feedback loop's unification phase is complete.
- **Internal governance:** Colombia, Venezuela, and Ecuador become constituent states within the federation, preserving internal autonomy. Indigenous autonomous zones within former national territories are preserved under federal law.

**Colombia's arc:** The 2016 peace process with FARC holds unevenly. US collapse ends Plan Colombia. Left-leaning governments (Petro successor) deepen social spending and land reform. By the late 2030s, Colombia is a socially progressive but institutionally weak state — the unification with its stronger-neighbor Venezuela and wealthier Ecuador provides institutional reinforcement.
- **Ecuador's arc:** Dollarization (adopted 2000) becomes a crisis as the US dollar collapses. Ecuador de-dollarizes in the early 2030s, adopting a BRICS+ basket or yuan-anchor. Political instability peaks during transition, then left-indigenous governments push toward socialist economics. Ecuador's Pacific ports and Galápagos biosphere become the federation's maritime gateway.
- **Venezuela's arc (US puppet regime, power vacuum):** On January 3, 2026, US forces captured President Nicolás Maduro in Caracas, installing Vice President Delcy Rodríguez. The regime is a US puppet with no independent legitimacy. When US federal capacity declines (~2032-2035), the puppet regime collapses. A chaotic transition (~2035-2040) produces a left-nationalist government that rebuilds the Chavista welfare state without the authoritarian excesses. Venezuela does not return to its pre-2026 oil economy but achieves modest stability. Oil reserves and Orinoco industrial base become the federation's economic anchor.

**Peru — The Holdout:**
- Chronic political instability prevents Peru from joining the Gran Colombia process. Revolving-door presidencies, constitutional crises, and a fragmented party system make unification negotiations impossible.
- Left-indigenous movements (related to mining conflicts and the Amazon) gain ground but cannot consolidate the national consensus needed for accession.
- Peru fragments into coastal/liberal and highland/indigenous political zones but remains a single state — too internally fractured for the unification treaties that absorbed its neighbors.

- **Links to US collapse:** The end of US interventionism is the precondition for Gran Colombia. US-backed military, economic, and diplomatic pressure against Latin American integration (a consistent 200-year policy pattern from the Monroe Doctrine through Plan Colombia) is the primary external obstacle that falls away. Venezuela's Rodriguez regime — the last US puppet in South America — collapses, removing the final anti-unification veto.
...
### 6. Southern Cone (Argentina-Uruguay, Paraguay, Falklands/Malvinas)
- **Orientation:** Post-flip unification, regional stability (MEDIUM confidence)
- **Argentina-Uruguay unification:** After Argentina's post-Milei left rebound (~2034-2036), the historic cultural and economic ties between the two Rioplatense states — already among the deepest in South America — drive unification by ~2048. Uruguay, the most politically functional state on the continent, provides institutional stability to Argentina's volatile politics. The Buenos Aires–Montevideo axis consolidates under a single sovereignty. Combined population ~50M.
- **Paraguay:** Authoritarian tendencies, agricultural/energy economy (Itaipu hydro dam, soy). In Brazil's economic orbit — pulled in whatever direction Brazil pulls.
- **Falkland Islands, South Georgia & South Sandwich Islands — Argentine acquisition:** Reactionary Milei-era Argentina (~2028-2032), in its final desperate act before collapse, exploits the UK's accelerated post-Brexit degradation — Scotland's exit from the UK, loss of US airlift capabilities (USAF no longer maintains Ascension Island staging base), Royal Navy budget collapse to 1.2% of GDP, and the UK's withdrawal from global power projection. Argentina occupies the islands in a low-resistance campaign (~2028-2030). After Argentina's revolutionary flip (~2034-2036), the military occupation is converted into an autonomous zone with special status for English-speaking residents under the unified Argentina-Uruguay state. The islands appear as part of Argentina on the 2050 map.

### 7. The Guianas (Guyana, Suriname, Cayenne)
- **Orientation:** Resource economies, cooperation council (LOW confidence)
...
- **Cayenne (formerly French Guiana):** France's post-EU retrenchment and overseas-territory cost-cutting leads to negotiated independence in the 2040s. Former overseas department becomes the independent Republic of Cayenne. Capital: Cayenne. Population ~400,000. Joins CARICOM. Its spaceport (Guiana Space Centre, operated by Arianespace/ESA) becomes a leased facility — a key revenue source and geopolitical bargaining chip.
- **Guianas Cooperation Council:** Guyana, Suriname, and Cayenne establish a trilateral council for economic coordination, climate resilience, and infrastructure integration. Not a political unification — border disputes between Guyana and Suriname (New River Triangle) and between Guyana and Venezuela (Essequibo, inherited by Gran Colombia) remain unresolved but managed. Guyana's oil wealth anchors the council's development fund.
...
- **BRICS+ integration:** South America is a natural BRICS+ partner region — commodity-rich, increasingly left-aligned (Gran Colombia, Argentina-Uruguay, Bolivia), connected to Latin America/Atlantic trade routes. Brazil leads regional BRICS+ integration, followed by Gran Colombia and Argentina-Uruguay. The unified states negotiate better terms than their fragmented predecessors. The region becomes a BRICS+ agricultural and mining supplier.
...
- **US-backed government collapse cascade:** Argentina (Milei) and Venezuela (Rodriguez) are the two US-aligned governments in South America. Their collapse in the early-to-mid 2030s, triggered by US federal dissolution, removes the last right-wing anchors on the continent. South America's political center of gravity shifts decisively left — but through crisis and default, not smooth transition. This left-wave enables the unifications (Gran Colombia, Argentina-Uruguay) that define the 2050 map.
- **Unification trajectory:** The revolutionary feedback loop's unification phase (per prediction-002) manifests in two South American mergers by 2050: Gran Colombia (COL+ECU+VEN) and Argentina-Uruguay (ARG+URY). Both follow the pattern: left-turn consolidation → pan-nationalist sentiment activation → confederal compact → full federation.
...
- **Colombian peace process:** Whether the 2016 peace agreement survives without US funding and security support. A return to full-scale conflict could delay or derail Gran Colombia unification. **(MEDIUM)**
- **Gran Colombia federation depth:** Whether the confederal-to-federal transition succeeds or remains a loose coordinating council. The institutional capacity gap between Colombia, Ecuador, and Venezuela creates friction. **(MEDIUM)**
- **Peruvian trajectory:** Whether Peru eventually joins Gran Colombia in a later wave, or remains permanently outside. Depends on whether post-2050 Peruvian politics stabilizes enough for accession negotiations. **(LOW)**
...
- The Great Lakes needs lithium for battery manufacturing — South America is its primary supplier; trade routes through the Panama Canal or around Cape Horn
